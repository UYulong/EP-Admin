<template>
  <div class="ep-conainer">
    <vxe-table
      border :column-config="{ resizable: true }" :scroll-y="{ enabled: false }"
      :span-method="mergeRowMethod" :data="tableData"
    >
...
<script lang="ts" setup name='VxeTable'>
...
const tableData = ref<RowVO[]>([
  ...
  { id: 10002, key: 'app.label.name', content: 'Name', language: 'en_US' },
  { id: 10003, key: 'app.label.sex', content: 'Name', language: 'zh_CN' },
